...
const faqs = [
  {
    question: "Who can join the Adda Millionaire program?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes, absolutely! Joining the Adda Millionaire program is completely free. There are no signup fees, hidden charges, or minimum requirements to get started.",
  },
  {
