...
const AdminLogin = () => {
  ...
  useEffect(() => {
    // Temporarily redirect directly to dashboard - auth will be configured later
        ...
        <Card className="shadow-xl border-2">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={loading}
              className="w-full bg-white text-gray-700 border-2 border-gray-300 hover:bg-gray-50 h-12 text-base font-medium shadow-sm"
              size="lg"
            >
              {loading ? (
                <>Signing in...</>
