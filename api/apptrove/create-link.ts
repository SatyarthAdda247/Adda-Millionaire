...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Link domain (NOT API domain). This is only used to construct the Unilink URL if needed.
    const APPTROVE_DOMAIN = process.env.APPTROVE_DOMAIN || process.env.VITE_APPTROVE_DOMAIN || 'applink.learnr.co.in';
